        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Mengenal lebih dekat TK Pembangunan dan komitmen kami dalam
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                {schoolInfo.mission.map((item, index) => (
                  <div
                    key={index}
                    className="bg-yellow-50 p-4 rounded-xl flex items-start space-x-3"
                  >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Berbagai program yang dirancang khusus untuk mengoptimalkan tumbuh
              kembang anak
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Guru-guru berpengalaman dan berdedikasi yang siap membimbing
              putra-putri Anda
            </p>
          </div>
